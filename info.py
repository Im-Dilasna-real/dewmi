...
def is_enabled(value, default):
    if value.lower() in ["true", "yes", "1", "enable", "y"]:
        ...
        return default
{
      "name": "Telegram-Group-Management-Bot-DewmiBot",
      "description": "A Powerful BOT to Make Your Groups Secured and Organized.",
	  "logo": "https://telegra.ph/file/1ead052789170e712384a.jpg",
      "keywords": [
         "Telegram",
         "Groupmanage",
         "Telegram-Group-Management-Bot-DewmiBot"
      ],   
   "repository": "https://github.com/hirunaofficial/Telegram-Group-Management-Bot-DewmiBot/",
   "addons": [
      {
         "options": {
            "version": "12"
   ...
   "env": {
      "TOKEN": {
         ...
         "required": true,
         "value": "2138073729:AAGGaGUCjYL--XuAasC6hQQNQ1e-6ABm-0M"
      },
      "API_ID": {
      ...
      "API_HASH": {
         ...
         "required": true,
         "value": "80a5825983b6652661162960a560f447"
      },    
